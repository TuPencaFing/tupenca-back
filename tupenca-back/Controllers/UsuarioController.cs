...
namespace tupenca_back.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                }else 
                {
                    ...
                    string To = Email, UserID, Password, SMTPPort, Host;
                        ...
                        var lnkHref = "<a href='" + Url.Action("ResetPassword", "Account", new { email = Email }, "http") + "'>Reset Password</a>";
        ...
        public IActionResult ResetPassword(string token, string password)
        {
            try
            {
                int id = _userService.getPersonaIdFromToken(token);
